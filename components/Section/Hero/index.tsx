...
const HeroSection = ({
  ...
  return (
    <Container classes="p-[16px]">
      <Main classes="bg-[linear-gradient(176.17deg,#f9fafb_0.94%,#edf0f3_316.54%)] shdaow-xl rounded-sm py-[104px] px-[12px] grid grid-cols-4 gap-8 md:grid-cols-6 lg:px-[105px] lg:py-[96px] lg:grid-cols-12">
